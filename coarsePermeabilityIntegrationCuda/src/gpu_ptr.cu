...
gpu_ptr_2D::gpu_ptr_2D(unsigned int width, unsigned int height, int border, float* cpu_ptr) {
...
gpu_ptr_2D::~gpu_ptr_2D() {
	cudaFree(data.ptr);
}

gpu_ptr_2D::copy(const gpu_ptr_2D& other, unsigned int x_offset, unsigned int y_offset, unsigned int width, unsigned int height, int border){
...
void gpu_ptr_2D::download(float* cpu_ptr, unsigned int x_offset, unsigned int y_offset, unsigned int width, unsigned int height){
	width = (width == 0) ? data_width :width;
	height = (height == 0) ? data_height : height;
...
void gpu_ptr_2D::upload(const float* cpu_ptr, unsigned int x_offset, unsigned int y_offset, unsigned int width, unsigned int height){
	width = (width == 0) ? data_width :width;
	height = (height == 0) ? data_height : height;
...
void gpu_ptr_2D::set(int value, unsigned int x_offset, unsigned int y_offset, unsigned int width, unsigned int height, int border){
	width = (width == 0) ? data_width :width;
	height = (height == 0) ? data_height : height;
...
void gpu_ptr_2D::set(float value, unsigned int x_offset, unsigned int y_offset, unsigned int width, unsigned int height){
	width = (width == 0) ? data_width :width;
	height = (height == 0) ? data_height : height;
...
gpu_ptr_1D::upload(const float* cpu_ptr, unsigned int x_offset, unsigned int width) {
	width = (width == 0) ? data_width : width;
...
gpu_ptr_1D::gpu_ptr_1D(unsigned int width, float* cpu_ptr) {
	data_width = width;
	data_ptr = 0;
...
gpu_ptr_1D::~gpu_ptr_1D() {
	cudaFree(data_ptr);
}

void gpu_ptr_1D::set(float value, unsigned int x_offset, unsigned int width) {
	width = (width == 0) ? data_width : width;
