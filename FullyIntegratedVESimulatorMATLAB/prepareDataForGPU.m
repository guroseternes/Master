function [east_face_index, north_face_index] = prepareDataForGPU(sol, Gt, rock, rock2D, fluidVE, bcVE, WVE, preComp,filenameData, filenameDim, filenameActive)
%close all
%Function to prepare data from matlab to the GPU 
gravity = 9.80665
zdim = 100;
border = 1;
